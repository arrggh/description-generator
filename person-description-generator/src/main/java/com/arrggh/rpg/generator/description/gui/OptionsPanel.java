...
public class OptionsPanel extends JPanel {
    ...
    private String[] getPossibleHairColors() {
        ...
        return appendRandomToSet(getEntry().getHairColors());
    }
    ...
    private String[] getPossibleEyeColors() {
        ...
        return appendRandomToSet(getEntry().getEyeColors());
    }
    ...
    private String[] getPossibleSkinColors() {
        ...
        return appendRandomToSet(getEntry().getSkinColors());
    }

    private SystemRaceSexEntry getEntry() {
        return store.getEntry(getSystem(), getRace(), getSex());
    }
